...
# Import canonical VaR functions from src.computation.var
from src.computation.var import (
    var_historical,
    var_parametric,
    var_scale,
    es_historical,
...
# Import canonical stress functions from src.computation.stress
...
# Import canonical liquidity functions from src.computation.liquidity
from src.computation.liquidity import (
    days_to_liquidate,
    liquidity_buckets,
...
# Import canonical leverage computation from src.computation.leverage
from src.computation.leverage import compute_leverage

# Import canonical P&L attribution from src.computation.attribution
from src.computation.attribution import compute_pnl_attribution

# HISTORICAL_SCENARIOS is now imported from src.computation.stress above
...
# ================================================================
# NOTE: These functions are now imported from src.computation.var
...
#   liquidity_adjusted_var
#   → from src.computation.liquidity
# Functions are imported above and re-exported for backward compatibility.


# compute_pnl_attribution() is now imported from src.computation.attribution (see line 85)
...
# compute_leverage() is now imported from src.computation.leverage (see line 81)
