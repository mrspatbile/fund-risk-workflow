...
Usage
-----
    from src.annex_vi_export import generate_annex_vi_report
    generate_annex_vi_report(engine, valuation_date='2026-05-13')

    # or from the command line:
    python -m src.annex_vi_export

Output
------
    data/annex_vi_report_<date>.xlsx
...
def generate_annex_vi_report(
    ...
    out_path = os.path.join(output_dir,
                            f'annex_vi_report_{valuation_date}.xlsx')
